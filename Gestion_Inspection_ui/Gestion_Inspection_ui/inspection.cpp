...
bool Inspection::modifier(int IDIN,QDate date_inspection,int frais_inspection,QString methode_inspection,QString etat_inspection,QString type_inspection)
{
    QSqlQuery query;


    query.prepare("UPDATE INSPECTION SET DATE_MISSION=:DATE_MISSION , FRAIT_MISSION=:FRAIT_MISSION, METHODE=:METHODE , ETAT=:ETAT ,TYPE_MISSION=:TYPE_MISSION  where IDIN=:IDIN");
    query.bindValue(":IDIN", static_cast<double>(IDIN));
    query.bindValue(":DATE_MISSION", date_inspection);
    query.bindValue(":FRAIT_MISSION", static_cast<double>(frais_inspection));
    query.bindValue(":METHODE", methode_inspection);
    query.bindValue(":ETAT",etat_inspection);
    query.bindValue(":TYPE_MISSION",type_inspection);
...
/*bool Inspection::modifier(int IDIN, QDate date,float frais_inspection, QString methode, QString etat,QString type)
{
